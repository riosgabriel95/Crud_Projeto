...
const saveClient = () => {
    if (isValidFields()) {
        const client = {
            ...
            nascimento: document.getElementById('dtBirth').value,
...
const fillFields = (client) => {
    ...
    document.getElementById('document').value = client.cpf
    document.getElementById('dtBirth').value = client.nascimento
